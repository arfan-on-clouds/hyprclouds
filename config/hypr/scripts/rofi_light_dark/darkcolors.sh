...
colors_css="$HOME/.config/material-you/waybar-colors2.css"

# Path to the output CSS file
output_css="$HOME/.config/rofi/powermenu/type-2/darkcolors.rasi"
...
background=$(extract_color "dark-background") || exit 1
background_alt=$(extract_color "dark-on-secondary") || exit 1
foreground=$(extract_color "dark-secondary") || exit 1
selected=$(extract_color "dark-primary") || exit 1
active=$(extract_color "dark-outline") || exit 1
urgent=$(extract_color "dark-primary") || exit 1
