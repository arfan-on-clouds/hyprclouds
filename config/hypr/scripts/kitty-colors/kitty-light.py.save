...
target_file = os.path.expanduser("~/.config/kitty/light/kitty.conf")  # Update this path if needed
...
new_colors = {
    ...
    'cursor': colors[7],            # Desired cursor color
    'color0': colors[7],        # Custom color0
    'color1': colors[6],        # Custom color1
    'color2': colors[5],        # Custom color2
    'color3': colors[4],        # Custom color3
    'color4': colors[3],        # Custom color4
    'color5': colors[2],        # Custom color5
    'color6': colors[1],        # Custom color6
    'color7': colors[7],        # Custom color7
    'color8': colors[15],        # Custom color8
    'color9': colors[14],        # Custom color9
    'color10': colors[13],      # Custom color10
    'color11': colors[12],      # Custom color11
    'color12': colors[11],      # Custom color12
    'color13': colors[10],      # Custom color13
    'color14': colors[9],      # Custom color14
    'color15': colors[8],      # Custom color15
}
